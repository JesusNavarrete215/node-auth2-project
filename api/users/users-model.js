...
function find() {
   ...
   */
    ...
    /*select user_id, username, role_name from users join roles on users.role_id = roles.roles_id */
    return db('users')
...
function findBy(filter) {
   ...
   */
  /* select user_id, username, password, role_name from users join roles on users.role_id = roles.role_id where users.user_id = id*/
  return db('users')
  .join('roles', 'users.role_id', 'roles.role_id')
